...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#3D9970' : '#3F51B5',
  brandInfo: '#3D9970',
  brandSuccess: '#3D9970', //dark green
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  brandDark: '#3D9970', //dark green
  brandLight: '#c4f5df', //light green
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'Zocial' : 'Roboto',
  fontSizeBase: 15,
  get fontSizeH1() {
